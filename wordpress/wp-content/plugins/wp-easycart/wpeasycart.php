...
define( 'EC_CURRENT_VERSION', '4_2_5' );
define( 'EC_CURRENT_DB', '1_30' );/* Backwards Compatibility */
define( 'EC_UPGRADE_DB', '65' );
...
function ec_ajax_get_stripe_complete_payment( ){
	...
	if( isset( $_POST['shipping_address'] ) ){
		...
		$GLOBALS['ec_cart_data']->cart_data->shipping_state = ( $_POST['shipping_address']['region'] != '' ) ? $_POST['shipping_address']['region'] : $_POST['shipping_address']['dependentLocality'];
	...
	if( isset( $_POST['billing_name'] ) && $_POST['billing_name'] != '' ){
		...
		$GLOBALS['ec_cart_data']->cart_data->billing_city = $_POST['billing_address']['city'];
		$GLOBALS['ec_cart_data']->cart_data->billing_state = ( $_POST['billing_address']['region'] != '' ) ? $_POST['billing_address']['region'] : $_POST['billing_address']['dependentLocality'];
		...
		for( $i=0; $i<count( $shipping_names ) - 1; $i++ ){
			if( $i > 0 )
				$GLOBALS['ec_cart_data']->cart_data->billing_first_name .= ' ';
			$GLOBALS['ec_cart_data']->cart_data->billing_first_name .= $shipping_names[$i];
		}
        $GLOBALS['ec_cart_data']->cart_data->billing_last_name = ( count( $shipping_names ) > 1 ) ? $shipping_names[count( $shipping_names ) - 1] : '';
		$GLOBALS['ec_cart_data']->cart_data->billing_address_line_1 = ( count( $_POST['shipping_address']['addressLine'] ) > 0 ) ? $_POST['shipping_address']['addressLine'][0] : '';
		$GLOBALS['ec_cart_data']->cart_data->billing_address_line_2 = ( count( $_POST['shipping_address']['addressLine'] ) > 1 ) ? $_POST['shipping_address']['addressLine'][1] : '';
		$GLOBALS['ec_cart_data']->cart_data->billing_city = $_POST['shipping_address']['city'];
		$GLOBALS['ec_cart_data']->cart_data->billing_state = ( $_POST['shipping_address']['region'] != '' ) ? $_POST['shipping_address']['region'] : $_POST['shipping_address']['dependentLocality'];
		$GLOBALS['ec_cart_data']->cart_data->billing_zip = $_POST['shipping_address']['postalCode'];
		$GLOBALS['ec_cart_data']->cart_data->billing_country = $_POST['shipping_address']['country'];
		$GLOBALS['ec_cart_data']->cart_data->billing_phone = $_POST['phone'];
