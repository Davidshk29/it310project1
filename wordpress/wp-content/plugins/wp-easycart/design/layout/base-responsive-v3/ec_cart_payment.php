...
<div class="ec_cart_left">
        	...
        	<script>
				...
				affirm.checkout({
					...
					billing: {
						...
						phone_number:				"<?php echo htmlspecialchars( $GLOBALS['ec_cart_data']->cart_data->billing_phone, ENT_QUOTES ); ?>",
						email:						"<?php echo htmlspecialchars( $GLOBALS['ec_cart_data']->cart_data->email, ENT_QUOTES ); ?>"
					},
					shipping: {
						name: {
	...
	var email = '<?php echo htmlspecialchars( $GLOBALS['ec_cart_data']->cart_data->email, ENT_QUOTES ); ?>';
	var billing_contact = {
				...
				try {
					...
					form.addEventListener( 'submit', function( event ){
						...
						if( payment_method != 'credit_card' ){
							...
							var shipping_phone = '<?php echo htmlspecialchars( $GLOBALS['ec_cart_data']->cart_data->shipping_phone, ENT_QUOTES ); ?>';
							var email = '<?php echo htmlspecialchars( $GLOBALS['ec_cart_data']->cart_data->email, ENT_QUOTES ); ?>';
